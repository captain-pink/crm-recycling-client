  ...
  return (
    <Box sx={{ position: 'relative' }}>
      ...
      <Grid container justifyContent={'space-between'} marginTop={'2.5rem'}>
          <Grid item lg={5.8} xl={5.8} sx={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '2rem', overflow: 'hidden' }}>
            <Box
              sx={{
                top: 0,
                bottom: 0,
            ...
            >
              <Typography color={'primary'} variant="h1" fontWeight={600} fontSize={'2rem'} textAlign={'center'}>
          ...
          <Grid item lg={5.8} xl={5.8} overflow={'hidden'} sx={{ borderRadius: '1rem', padding: 0 }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              >
                ...
                />
                <Box sx={{width: '55%', display: 'flex', flexDirection: 'column', gap: '1rem'}}>
                  <Typography color={'primary'} variant="h1" fontWeight={600} fontSize={'2rem'} >
                  ...
                  <Typography
                    ...
                    sx={{ textWrap: 'balance' }}
                  >
                    Showcase the environmentally conscious design of your devices, emphasizing recyclable components and responsible manufacturing.
                  </Typography>
                </Box>
              </Box>
              ...
              >
                ...
                <Box sx={{width: '55%', display: 'flex', flexDirection: 'column', gap: '1rem'}}>
                  ...
                  <Typography
                    ...
                    sx={{ textWrap: 'balance' }}
                  >
                    Receive accolades for your commitment to the environment. Stand out as an industry leader in responsible and sustainable production.
                  </Typography>
                </Box>
              </Box>
            </Box>
